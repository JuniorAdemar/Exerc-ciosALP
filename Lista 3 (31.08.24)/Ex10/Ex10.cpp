...
void convert(int opt, float x, float real, float dolar, float euro)
{
float result;
using namespace std;
...
int main(){
    ...
    int option;
    float value, real_cotation, dolar_cotation, euro_cotation;
    ...
    convert(option, value, real_cotation, dolar_cotation, euro_cotation);
}